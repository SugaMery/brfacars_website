...
export class LocationDeVoitureComponent {
  ...
  private setMetaTags(): void {
    this.metaService.addTags([
      ...
      { name: 'keywords', content: 'location de voiture, location auto, voitures de location, louer une voiture, location véhicule' },
      ...
      { property: 'og:image', content: 'https://www.brfacars.com/assets/images/location-de-voiture.webp' },
      { property: 'og:url', content: 'https://www.brfacars.com/blog/location-de-voiture' }
    ]);
  }
}
